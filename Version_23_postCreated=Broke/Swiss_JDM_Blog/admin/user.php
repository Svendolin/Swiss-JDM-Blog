...
<section id="admin-control">
  ...
  <div class="table-container">
    ...
    <div class="informationzone">
      <h2 class="info">
        <i class="fas fa-info-circle"></i> Delete users so that they can re-register if they have made a mistake.<br>
          ...
          <?php if (isset($data) && count($data) > 0) { ?>
            <?php foreach ($data as $datapieces) { ?>
              <tr>
                ...
                <td data-label="Registration Date"><?php echo $datapieces['userCreated']; ?></td>
