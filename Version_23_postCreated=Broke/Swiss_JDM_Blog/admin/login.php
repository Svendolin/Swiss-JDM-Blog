...
<section id="admin-login">
	...
	<div class="center">
		...
		<form method="post">
			<div class="txt_field">
				<input type="text" name="admin_name" id="fld_username" value="">
				<span></span>
				<label>*Username</label>
			</div>
			<div class="txt_field">
				<input type="password" name="admin_password" id="fld_pw" value="">
				<span></span>
	...
	if (isset($_GET["error"])) {
		if ($_GET["error"] == "emptyinputlogin") {
			echo "<p style='color:white; background:red;padding:0.5rem;margin-top:2rem;border-radius:10px;'><i class='fas fa-exclamation-circle'></i>  Please fill all fields!</p>";
		} else if ($_GET["error"] == "wronglogin") { // Error handler in functions.inc.php
			echo "<p style='color:white; background:red;padding:0.5rem;margin-top:2rem;border-radius:10px;'><i class='fas fa-exclamation-circle'></i>  Admin login information is not correct!</p>";
