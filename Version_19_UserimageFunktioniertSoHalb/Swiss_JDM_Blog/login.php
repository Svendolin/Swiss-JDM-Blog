...
<div class="login-container"> <!-- Whole login section as a container -->
  ...
  <!------------ [A] SIGN-IN FORM (AKA as login.php in usual projects) ---------------------------------->
    <div class="signin-signup">
        ...
        // PHP Error Input Messages connected to signup.inc.php -->
          if (isset($_GET["error"])) {
            if ($_GET["error"] == "emptyinput") {             // "emptyinput" is defined at signup.inc.php combined with the function at functions.inc.php
              ...
              echo "<p><i class='fas fa-exclamation-circle'></i>  Sorry, Username or Email is already taken!<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Click 'Join us' to try again!</p>";
            }
      ...
      <form action="includes/signup.inc.php" class="sign-up-form" method="post" enctype="multipart/form-data"> <!-- NEW: action="" => The page where the user is going to be directed / method = "" set to POST (no visible data in the url) -->
