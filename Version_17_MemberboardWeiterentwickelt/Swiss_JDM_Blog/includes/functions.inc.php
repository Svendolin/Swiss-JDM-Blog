...
function createUser($conn, $name, $username, $car, $state, $email, $pwd, $membertype) {
  $sql = "INSERT INTO users (usersName, usersUid, usersCar, usersState, usersEmail, usersPwd, memberType) VALUES (?, ?, ?, ?, ?, ?, );"; // Prepare Statement (CUDR CREATE Operator):
