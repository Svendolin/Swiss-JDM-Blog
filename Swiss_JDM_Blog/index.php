    ...
    <div class="blog">
      ...
      <div class="container">
        ...
        <div class="owl-navigation">
          <span class="owl-nav-prev" aria-label="true"><i class="fas fa-long-arrow-alt-left"></i></span>
          <span class="owl-nav-next" aria-label="true"><i class="fas fa-long-arrow-alt-right"></i></span>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="site-content">
      ...
      <div class="posts">
        ...
        <?php foreach ($data as $datapiece) { ?>
          ...
          <div class="post-content" data-aos="zoom-in" data-aos-delay="200">
            ...
            <div class="post-image">
              <!---- USEFUL Image-Structure of the post for PHP and post information ---->
              <div>
                <!-- When the img is NOT empty, so the user posted a picture, show this: -->
                <?php if (!empty($datapiece['post_image'])) { ?>
                  <img class="img" src="<?php echo IMAGEFOLDER . '/' . $datapiece['post_image']; ?>" />
                <?php } ?>
                <!-- When the img IS empty, so the user FORGOT to post a picture, show this: -->
                <?php if (empty($datapiece['post_image'])) { ?>
                  <img class="img" src="images/blog-posts/empty.jpg" style="max-height:800px;" />
                <?php } ?>
              </div>
              <!--x- USEFUL Image-Structure of the post for PHP and post information -x-->
            ...
            <div class="post-title">
              ...
              <a href="post.php?article=<?php echo $slug; ?>"><?php echo stripslashes($datapiece['post_title']); ?></a>
        ...
        <div class="pagination flex-row">
          <a href=""><i class="fas fa-chevron-left" aria-label="previous"></i></a>
          ...
          <a href=""><i class="fas fa-chevron-right" aria-label="next"></i></a>
        </div>
      ...
      <aside class="sidebar">
        ...
        <div class="newsletter" data-aos="fade-up" data-aos-delay="300">
          <!-- Newsletter part -->
          <h2 class="title-sidebar">Contact for Support</h2>
          <h3 class="under-title-sidebar">Leave your Email - We contact you ASAP</h3>
          <div class="form-element">
            ...
            <button class="btn form-btn" role="button" aria-label="send">Send</button>
          </div>
        </div>
        <hr class="sideline">
